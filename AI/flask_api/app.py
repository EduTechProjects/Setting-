...
api_key = os.environ.get('MySecret')
...
########################################## audio recognition
    ...
    resampled_audio = scipy.signal.resample(audio_data, int(len(audio_data) * rate_ratio))
...
########################################## GPT transform
    ...
    response = openai.ChatCompletion.create(
        ...
        messages = [
            ...
            {"role": "user", "content": "Could you please correct any grammar or spelling errors in above sentences?"}
        ],
        temperature = 0,
        max_tokens=2048,
